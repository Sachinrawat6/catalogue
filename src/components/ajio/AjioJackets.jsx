...
const generateAjioJacketsListing = (selectedData) => {
  const csvHeaders = [
    "Style Code",
    "Style Description",
    "Item SKU",
  ...
  const csvData = selectedData.filter((product)=>product.style_type==="Coat" ||product.style_type==="Jacket" || product.style_type.includes("Jacket")  )
  .flatMap((product) =>
    sizes.map((size) => {
      ...
      let washCareKey =
        typeof product.care_instruction === "string" ? product.care_instruction.trim() : "";
      ...
      return {
        ...
        "Feature":"",
        Fitting: "",
        Neckline:neckline || product.neckline,
  ...
  link.download = "ajio_jacket_listing.csv";
...
export default generateAjioJacketsListing;