...
const generateAjioDressListing = (selectedData) => {
  const csvHeaders = [
    "Style Code",
    "Style Description",
    "Item SKU",
  ...
  const csvData = selectedData.filter((product)=>product.style_type==="Dress" ||product.style_type==="Kaftan"  )
  .flatMap((product) =>
    sizes.map((size) => {
  ...
  link.download = "ajio_dress_listing.csv";
  document.body.appendChild(link);
  link.click();
  document.body.removeChild(link);
};

export default generateAjioDressListing;
