...
const generateAjioSkirtListing = (selectedData) => {
  const csvHeaders = [
    "Style Code",
    "Style Description",
    "Item SKU",
  ...
  const csvData = selectedData.filter((product)=>product.style_type==="Skirt" ||product.style_type.includes("skirt")  )
  .flatMap((product) =>
    sizes.map((size) => {
  ...
  link.download = "ajio_skirt_listing.csv";
  document.body.appendChild(link);
  link.click();
  document.body.removeChild(link);
};

export default generateAjioSkirtListing;
