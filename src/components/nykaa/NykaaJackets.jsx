...
const generateNykaaJackeAndShrugeListing = (selectedData) => {
  const csvHeaders = [
    "Vendor SKU Code",
    "Gender",
    "Brand Name",
  ...
  .flatMap((product) =>
    sizes.map((size) => {
      ...
      const patternMapping = {
        ...
        "Solid/Plain, Floral": "Solid/Plain",
        "Solid/Plain, Stripes": "Solid/Plain",
        "Solid/Plain, Abstract": "Solid/Plain",
  ...
  link.download = "Nykaa_Jacket_And_Shrug_listing.csv";
  document.body.appendChild(link);
  link.click();
  document.body.removeChild(link);
};

export { generateNykaaJackeAndShrugeListing };
