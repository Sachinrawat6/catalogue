...
const generateNykaaShirtListing = (selectedData) => {
  const csvHeaders = [
    "Vendor SKU Code",
    "Gender",
    "Brand Name",
  ...
  .filter((product)=>product.style_type==="Shirt" ||product.style_type==="shirt"  )
  .flatMap((product) =>
    sizes.map((size) => {
      ...
      return {
        ...
        // return_available: product.return_available || "YES",
        // "Is Replaceable": product.is_replaceable || "YES",
        ...
        // "Length for Garment": sizeData[size]?.[3] ?? "",
        ...
        // "Shirts Tops and Crop Tops Subcategory":"Tops",
  ...
  link.download = "Nykaa_shirt_listing.csv";
  document.body.appendChild(link);
  link.click();
  document.body.removeChild(link);
};

export { generateNykaaShirtListing };
