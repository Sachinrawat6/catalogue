...
const generateNykaaTopListing = (selectedData) => {
  const csvHeaders = [
    "Vendor SKU Code",
    "Gender",
    "Brand Name",
  ...
  .filter((product)=>product.style_type==="Top" ||product.style_type==="top"  )
  .flatMap((product) =>
    sizes.map((size) => {
  ...
  link.download = "Nykaa_top_listing.csv";
  document.body.appendChild(link);
  link.click();
  document.body.removeChild(link);
};

export { generateNykaaTopListing };
